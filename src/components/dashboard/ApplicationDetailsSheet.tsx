...
import { Building2, MapPin, Calendar, DollarSign, ExternalLink, FileText, ChevronRight } from "lucide-react";
...
export function ApplicationDetailsSheet({
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="sm:max-w-md w-full p-0 gap-0 border-l border-zinc-200 bg-white">
                <div className="h-full flex flex-col">
                    ...
                    <div className="bg-zinc-50 p-6 border-b border-zinc-100">
                        <SheetHeader className="text-left space-y-4">
                            ...
                            <div>
                                <SheetTitle className="text-3xl font-display font-black text-black leading-tight tracking-tight">
                                    {application.role}
                                </SheetTitle>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-8">
                        ...
                        {application.notes && (
                            <div className="space-y-3">
                                ...
                                <div className="bg-amber-50/50 p-4 rounded-xl border border-amber-100/50 text-sm text-zinc-700 whitespace-pre-wrap leading-relaxed font-dm-sans">
                                    {application.notes}
                                </div>
                            </div>
                        )}
